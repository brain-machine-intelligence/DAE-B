% modified from BG_tStep. same behavior but save outputs every trial not
% every time step to save simulation time and memory
...
function [trials, As, Qps, Qms, Qs, PVs, GPes, GPis] = BG_trial (para, para2, para3, para4)       
