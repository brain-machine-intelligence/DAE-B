% Modified from BG_tStep to artificially increase GPe-to-STN projection by
% pvN times since trial pvX. 
...
function [trials, As, Qps, Qms, Qs, PVs, GPes, GPis] = BGpv (para, para2, para3, para4, pvX, pvN)
