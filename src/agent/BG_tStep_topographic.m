%% Modified from BG_tStep to have action-specific connectivity between GP and STN
...
function [trials, As, Qps, Qms, Qs, GPes, GPis] = BG_tStep_topographic (para, para2, para3, para4)        
...
% pv = mean(GPe')';  % commented to maintain action-specific connectivity 

Cortex= 0; 
% STN = STNc + Cortex- pv*pvf;  % commented to maintain action-specific connectivity 
STN = STNc + Cortex- GPe*pvf; 
